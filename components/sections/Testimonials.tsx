      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-10 sm:mb-12">
          ...
          <motion.div
            ...
            className="w-16 h-0.5 bg-[#3b82f6] mx-auto mt-4 mb-4"
          />
        ...
        <div className="flex justify-end gap-3 mb-6 max-w-6xl mx-auto px-2">
          <button
            ...
            className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border border-[#3b82f6]/50 bg-black/60 text-[#60a5fa] hover:bg-[#3b82f6] hover:text-white flex items-center justify-center transition-all duration-300 shadow-md cursor-pointer"
          >
        ...
        >
          {testimonials.map((testi: any, i: number) => (
            ...
            >
              <div className="h-full p-6 sm:p-8 rounded-3xl bg-[#0c0f15] border border-white/15 hover:border-[#3b82f6]/60 shadow-xl transition-all duration-300 flex flex-col justify-between group relative overflow-hidden text-left">
                {/* Quote Icon */}
                <Quote className="absolute top-6 right-6 w-10 h-10 text-white/5 group-hover:text-[#3b82f6]/20 transition-colors duration-300" />

                {/* 5 Rating Stars */}
                <div className="flex items-center gap-1 mb-4 text-[#3b82f6]">
                  {[...Array(5)].map((_, s) => (
                    <Star key={s} className="w-4 h-4 fill-[#3b82f6] stroke-[1.5]" />
                  ))}
                </div>
                ...
                <div className="mt-auto pt-4 border-t border-white/10 relative z-10 flex flex-col">
                  ...
                  <p className="text-[10px] sm:text-xs font-bold text-[#60a5fa] uppercase tracking-wider mt-0.5">
                    {testi.role}
                  </p>
                </div>
              </div>
